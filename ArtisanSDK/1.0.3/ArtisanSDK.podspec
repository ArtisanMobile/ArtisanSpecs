Pod::Spec.new do |s|
  s.name         = "ArtisanSDK"
  s.version      = "1.0.3"
  s.summary      = "The first all-in-one platform for mobile app analytics, A/B testing, and personalization."
  ...
  s.source       = { :git => "https://github.com/ArtisanMobile/ArtisanSDK.git", :tag => '1.0.3' }
  s.platform     = :ios, '5.0'
